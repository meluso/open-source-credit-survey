...
def get_option_definitions():
    ...
    optionDefinitions = {
        ...
        'freq_seenBy2': 'Fully visible (seen by 2 or more people)',
        'freq_seenBy1': 'Partially visible (seen by 1 other person)',
        'freq_seenBy0': 'Not visible (seen by 0 other people)',
        'satis_taskFreq': 'Satisfaction with credit frequency',
        'credit_importance': 'Importance of receiving credit',
        'order': 'Anchored to low visibility (vs to high visibility)',
